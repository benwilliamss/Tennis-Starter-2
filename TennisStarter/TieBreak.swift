...
class TieBreak {
    ...
    private func Game5TieBreak() -> Bool {
       return (Player1.GetCurrentGamesWonInSet() == 12 && Player2.GetCurrentGamesWonInSet() == 12) &&
                    (Player1.GetSetsWon() == 2 && Player2.GetSetsWon() == 2)
    }
    
    private func TieBreakButNotGame5() -> Bool{
        return (Player1.GetCurrentGamesWonInSet() == 6 && Player2.GetCurrentGamesWonInSet() == 6) &&
                !(Player1.GetSetsWon() == 2 && Player2.GetSetsWon() == 2)
    }
    ...
    func TieBreakSetWonSet5() -> Bool {
       ...
       return
        ((Player1.GetCurrentGamesWonInSet() == 13 && Player2.GetCurrentGamesWonInSet() == 12) ||
         (Player1.GetCurrentGamesWonInSet() == 12 && Player2.GetCurrentGamesWonInSet() == 13)) &&
            (Player1.GetSetsWon() == 2 && Player2.GetSetsWon() == 2)
    }
    func TieBreakSetWonNotSet5() -> Bool{
        //used to determine tie break set win - for game 5
            return  ((Player1.GetCurrentGamesWonInSet() == 7 &&         Player2.GetCurrentGamesWonInSet() == 6) ||
                     (Player1.GetCurrentGamesWonInSet() == 6 && Player2.GetCurrentGamesWonInSet() == 7)) &&
                    !(Player1.GetSetsWon() == 2 && Player2.GetSetsWon() == 2)
        }
}
